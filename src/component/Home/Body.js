...
function Body() {
  return (
    ...
    <p className='w-[20%]'> <img src={Dot} alt="jhhh" className='w-[8%] transform -translate-y-10 absolute' /> </p>
    </section>

    <section>

    <section className='px-5 md:px-28 py-20'>
   ...
   <p className='mt-5 text-xl text-[#7474AE]'> From advisors, investors, mentors, entrepreneurs, cofoundme provides you with multiple solutions to find the perfect fit for your startup.</p>
    ...
    <section className='flex flex-wrap md:flex-nowrap justify-between md:gap-40'>
   ...
   provides you with multiple solutions to find the perfect fit for your startup.</p>
    ...
    <section className='flex justify-between gap-24'>
      ...
      <section className='flex justify-between flex-wrap gap-10' style={{
       ...
       <p className='bg-[#F1F7FF] px-5 py-4 rounded-xl'>  <img src={Message1} alt='hgs' /> </p> 
        ...
        <div className='bg-white shadow-2xl flex flex-col gap-6 justify-center items-center text-center py-6 rounded-xl  px-5 w-[45%]'>
    ...
    <section className='px-5 md:px-28 pb-10 bg-white pt-32'>
